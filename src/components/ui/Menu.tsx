  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          e<span className="text-lime-500">Fi.</span>
        </Link>
      ...
      <div className="max-w-screen-2xl -z-30 md:z-0 w-full mx-auto px-10 mt-40 mb-10 md:pb-0 text-white flex flex-col md:flex-row items-center md:items-start">
        <div className="w-3/4 md:w-1/2 flex flex-col gap-y-8">
          {menuLinks.map((link, index) => (
            <Link
              ...
              key={index}
              activeProps={{ className: "text-lime-500" }}
              className="group w-full md:w-fit text-3xl md:text-4xl lg:text-6xl flex items-center justify-center gap-x-4"
            >
              <div
                className={`${
        ...
        <div className="w-1/2 mt-20 md:mt-0 flex flex-col gap-y-8">
          ...
          <div className="text-sm">
            <p className="text-lime-500">phone/whatsapp</p>
            <a
              href="tel:+2347078245559"
              target="_blank"
              rel="noreferrer noopener"
              className="underline hover:no-underline"
            >
