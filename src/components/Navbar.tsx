...
const Navbar = (props: { openMenu: () => void }) => {
  return (
    <nav className="max-w-screen-2xl w-full px-10 pt-10 pb-4 backdrop-blur flex items-center justify-between fixed top-0 left-1/2 -translate-x-1/2 z-40 text-white">
